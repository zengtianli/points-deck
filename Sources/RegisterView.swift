...
struct RegisterView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .toolbar { ToolbarItem(placement: .cancellationAction) { Button("取消") { store.error = nil; dismiss() } } }
        }
    }
}
